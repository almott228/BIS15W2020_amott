...
```{r}
#this gives you the number of columns, not the names
ncol(homerange)
...
```{r}
#if you look at your output this gives a strange answer
class(homerange)
#this will give you variable classes
#glimpse(homerange)
```
...
the question asks to display the levels (ie. the orders and taxa listed in the data)
...
#you can also use log10.hra to get the above answer
...
hra_ratio %>% 
  ...
  #you did this select already when you amde hra_ratio
