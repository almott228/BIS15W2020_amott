...
And then following the above suggestion-
```{r}
#mean(large$bodywt)
```
...
A comment to make your life easier, if in making your initial small and large sets you didn't filter out a single variable (weight), you could use those sets for all the following questions.
