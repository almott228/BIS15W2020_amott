...
There is no R code file for Lab one so I can't really leave you comments, unfortunately. I'll try and just put some suggestions up to here from what I can see in your markdown:

For "e" it would be a bit simpler to code this way-
```{r}
